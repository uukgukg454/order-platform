...
/**
 * Local copy of order-service's DistributedLockService — same logic,
 * duplicated here rather than shared, consistent with this project's "no
 * shared schema/utility module" decision.
 *
