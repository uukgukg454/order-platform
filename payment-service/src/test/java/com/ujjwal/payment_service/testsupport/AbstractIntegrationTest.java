package com.ujjwal.payment_service.testsupport;
 ...
 * (localhost:5434 Postgres, localhost:6379 Redis, localhost:9092 Kafka).
 *
...
public abstract class AbstractIntegrationTest {
    ...
    // (payment-postgres on localhost:5434) actually runs.
    @ServiceConnection
