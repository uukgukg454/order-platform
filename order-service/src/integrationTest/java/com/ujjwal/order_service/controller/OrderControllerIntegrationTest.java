 ...
 * service, JPA/Hibernate, Flyway migrations, Redis cache, Kafka publish)
 * against real containers — Postgres/Redis/Kafka all come from
 * AbstractIntegrationTest, not the dev environment.
 */
